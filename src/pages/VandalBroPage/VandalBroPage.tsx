...
import mblateImg from "@/assets/mblate.webp";
import { Link } from "react-router-dom";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
import { names } from "@/pages/VandalBroPage/constants/textConsts.ts";
      ...
      >
        <motion.div className="circle" id="one" variants={circle}>
          {Array(30)
            .fill(null)
            .map((_, index) => (
              <h1 key={index}>ВІН ЧОГОСЬ НЕ ХОТІВ, АЛЕ ТРЕБА</h1>
            ))}
        </motion.div>
          ...
          <div className="text">
            ...
            <div>
              <motion.p
                ...
                exit="out"
              >
                Ти 113 разів не хотів брати вандал, і вийгравав клатчі з
                шеріфом!
              </motion.p>
            </div>
          </div>
