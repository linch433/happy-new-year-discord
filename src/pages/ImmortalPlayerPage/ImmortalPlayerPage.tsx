      ...
      >
        <motion.div className="circle" id="one" variants={circle}>
          {Array(30)
            .fill(null)
            .map((_, index) => (
              <h1 key={index}>СИЛЬНИЙ ІММОРТАЛ</h1>
            ))}
        </motion.div>
          ...
          <div className="text">
            ...
            <div>
              <motion.p
                ...
                exit="out"
              >
                За 678 годин можна було вийти з дому 8136 разів, торкнутись
                трави і зайти назад в дім
              </motion.p>
            </div>
          </div>
        </animated.div>
...
export default ImmortalPlayerPage;
